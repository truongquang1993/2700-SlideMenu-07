...
protocol ViewControllerMainDelegate {
...
class ViewControllerMain: UIViewController {
    ...
    var delegate: ViewControllerMainDelegate?
    var infor: Infor?
...
//        self.view.endEditing(true)
    ...
    @IBAction func actionSave(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: .passDataMain, object: self.infor)
    }
}

extension ViewControllerMain: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
